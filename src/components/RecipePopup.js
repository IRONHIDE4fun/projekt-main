    ...
    <Dialog open={Boolean(recipe)} onClose={onClose} maxWidth="md" fullWidth>
      ...
      <DialogContent>
        <Box display="flex" flexDirection="column" alignItems="center">
          <img src={image} alt={label} style={{ width: '100%', maxHeight: '300px', objectFit: 'cover' }} />
          ...
          <Box display="flex" justifyContent="space-between" mt={2} width="100%">
            ...
            <Box flex="1" ml={1}>
              ...
              <Typography variant="body1">
                <a href={url} target="_blank" rel="noopener noreferrer">Kliknij tutaj, aby zobaczyć pełne instrukcje</a>
              </Typography>
            </Box>
          </Box>
        </Box>
